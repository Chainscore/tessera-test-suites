...
def enumerate_env() -> Optional[str]:
    """
    Return a path for the ${pwd}/40000.env file.
    ...
    try:
        ...
        return None
    path = os.path.join(cwd, '40000.env')
    return path
...
@click.option('-f', '--file', default=enumerate_env(),
              ...
              help="Location of the 40000.env file, defaults to 40000.env file in current working directory.")
...
def cli(ctx: click.Context, file: Any, quote: Any, export: Any) -> None:
    """This script is used to set, get or unset values from a 40000.env file."""
...
@click.option(
    ...
    default=True,
    help="Override variables from the environment file with those from the 40000.env file.",
)
