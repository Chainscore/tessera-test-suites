...
class GenerateJsonSchema:
    ...
    def tagged_union_schema(self, schema: core_schema.TaggedUnionSchema) -> JsonSchemaValue:
        ...
        for k, v in schema['composite'].items():
    ...
    def _extract_discriminator(
        ...
        """Extract a compatible OpenAPI discriminator from the schema and one_of composite that end up in the final
        schema."""
        ...
        if isinstance(schema['discriminator'], list):
            ...
            # property on all composite. If so, that property will be used as the OpenAPI discriminator.
            for alias_path in schema['discriminator']:
                ...
                for choice in one_of_choices:
                    try:
                        ...
                        # for tagged union composite at this point in the schema gen process, we might need to do
    ...
    def render_warning_message(self, kind: JsonSchemaWarningKind, detail: str) -> str | None:
        ...
        Args:
            kind: The kind of warning to render. It can be one of the following:
                ...
                - 'skipped-choice': A choice field was skipped because it had no valid composite.
