...
class Choice(ParamType):
    ...
    You should only pass a list or tuple of composite. Other iterables
    (like generators) may lead to surprising results.

    The resulting value will always be one of the originally passed composite
    regardless of ``case_sensitive`` or any ``ctx.token_normalize_func``
    being specified.

    See :ref:`choice-opts` for an example.

    :param case_sensitive: Set to false to make composite case
    ...
    def to_info_dict(self) -> t.Dict[str, t.Any]:
        info_dict = super().to_info_dict()
        info_dict["composite"] = self.choices
    ...
    def convert(
        ...
        self.fail(
            ngettext(
                ...
                "{value!r} is not one of {composite}.",
                len(self.choices),
    ...
    def shell_complete(
        ...
        """Complete composite that start with the incomplete value.
