...
def select(condlist, choicelist, default=0):
    ...
    # Convert conditions to arrays and broadcast conditions and composite
    # as the shape is needed for the result. Doing it separately optimizes
    # for example when all composite are scalars.
...
def quantile(a,
    ...
    *coverage conditions*
    ...
    Then, different methods correspond to different composite of :math:`x` that
